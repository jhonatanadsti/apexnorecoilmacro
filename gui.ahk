...
; global variable
global script_version := "Season 19"
...
Gui, Add, Text, x122 y-1 w330 h50 , ApexAHK
Gui, Font, ,
...
Gui, Add, Link, x190 y320 w160 h19 , <a href="https://github.com/jhonatanadsti/apexnorecoilmacro">Edit By: Jhonadsti</a>
ActiveMonitorInfo(X, Y, Width, Height)
xPos := Width / 2 - 477 / 2
yPos := Height / 2 - 335 / 2
Gui, Show, x%xPos% y%yPos% h335 w477, Apex AHK %script_version%
Return
...
IniRead:
    ...
    {
        MsgBox, Couldn't find settings.ini. Creating it for you!.
